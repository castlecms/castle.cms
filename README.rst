...
10. Once you have created a site in the development instance:
11. Run compile-resources script to allow `Makefile targets <./Makefile>`_ to work, ``bin/plone-compile-resources --site-id <Castle, or whatever you named your site>``
