...
class IGalleryTileSchema(IImagesTileSchema):
    ...
    show_thumbnails = schema.Bool(
        ...
        description=(
            ...
            u'This option only used in certain add-ons. In base Castle, this is simply always true.'
        ),
        missing_value=True,
        required=False,
    )
    ...
    show_image_counter =  schema.Bool(
        ...
        description=(
            ...
            u'This option only used in certain add-ons. In base Castle, this is simply always false.'
        ),
        missing_value=False,
        required=False,
    )
