...
try:
    vocabulary._permissions['plone.app.vocabularies.Groups'] = 'Modify portal content'  # noqa
    vocabulary._permissions['castle.cms.vocabularies.EmailCategories'] = 'Modify portal content'  # noqa
    vocabulary._permissions['castle.cms.vocabularies.Surveys'] = 'Modify portal content'  # noqa
    vocabulary._permissions['plone.app.vocabularies.Keywords'] = 'View'
except KeyError:
    vocabulary.PERMISSIONS['plone.app.vocabularies.Groups'] = 'Modify portal content'  # noqa
    vocabulary.PERMISSIONS['castle.cms.vocabularies.EmailCategories'] = 'Modify portal content'  # noqa
    vocabulary.PERMISSIONS['castle.cms.vocabularies.Surveys'] = 'Modify portal content'  # noqa
