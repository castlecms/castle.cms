"""
Pulled from https://raw.githubusercontent.com/shon/httpagentparser/master/httpagentparser/__init__.py
instead of including the dependency. Maybe bad, maybe good, I have not decided.
