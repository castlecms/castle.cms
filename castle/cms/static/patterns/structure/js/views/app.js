define([
  ...
  'castle-url/patterns/structure//js/views/table',
  'castle-url/patterns/structure//js/views/selectionwell',
  'castle-url/patterns/structure//js/views/generic-popover',
  'castle-url/patterns/structure//js/views/rearrange',
  'castle-url/patterns/structure//js/views/selectionbutton',
  'castle-url/patterns/structure//js/views/paging',
  'castle-url/patterns/structure//js/views/columns',
  'castle-url/patterns/structure//js/views/textfilter',
  'castle-url/patterns/structure//js/views/upload',
  'castle-url/patterns/structure//js/collections/result',
  'castle-url/patterns/structure//js/collections/selected',
  'mockup-utils',
  'translate',
  'pat-logger',
  'jquery.cookie'
